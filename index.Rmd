...
```{r, fig.width = 15, fig.height = 6.5, message=FALSE, warning=FALSE, echo=FALSE}
library(ggplot2)
...
<br>
***=left
```{r, fig.height = 6.5, message=FALSE, warning=FALSE, echo=FALSE}
library(ggplot2)
n = 1000
prevalence <- seq(0, 1, by = 0.001)
sensitivity <- 0.5
...
ggplot(data, aes(x = x, y = y)) + 
  ...
  theme_bw() +
  labs(x="Prevalence", y="Positive Predictive Value") +
  annotate('text', x = 0.5, y = 0.25, label = "50% Sensitive and 90% Specific", size = 5)
```
...
ggplot(data, aes(x = x, y = y)) + 
  ...
  theme_bw() +
  labs(x="Prevalence", y="Positive Predictive Value") +
  annotate('text', x = 0.5, y = 0.25, label = "90% Sensitive and 50% Specific", size = 5)
```
